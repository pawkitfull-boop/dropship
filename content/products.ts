...
export const products: Product[] = [
  {
    id: "prod_dryer_bag",
    handle: "foldable-pet-hair-blow-dryer-bag",
    title: "Foldable Pet Hair Blow Dryer Bag",
    ...
    included: [
      "1x Foldable Pet Hair Blow Dryer Bag"
    ],
    ...
    images: [
      { url: "/images/white-dog.jpg", altText: "Small white dog wearing Foldable Pet Hair Blow Dryer Bag", aspectRatio: "square" },
    ...
    variants: [
      { id: "var_dryer_s", title: "Small", price: 39.95, sku: "PDB-S", availableForSale: true },
      { id: "var_dryer_m", title: "Medium", price: 39.95, sku: "PDB-M", availableForSale: true },
      { id: "var_dryer_l", title: "Large", price: 39.95, sku: "PDB-L", availableForSale: true },
      { id: "var_dryer_xl", title: "XL", price: 39.95, sku: "PDB-XL", availableForSale: true }
    ],
