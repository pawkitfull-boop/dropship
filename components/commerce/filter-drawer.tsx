  ...
  const FilterContent = (
    <div className="space-y-12">
      ...
      <fieldset className="space-y-4">
        <legend className="text-mono-caption w-full border-b border-line pb-2 text-text-muted">Sort by</legend>
        <div className="flex flex-col space-y-3 pt-2">
          <label className="group flex h-11 cursor-pointer items-center gap-3 text-body text-text-secondary transition-colors hover:text-text-primary">
            <input 
              type="radio" 
              ...
              className="size-[18px] shrink-0 accent-bone" 
            />
            <span>Featured</span>
          </label>
          <label className="group flex h-11 cursor-pointer items-center gap-3 text-body text-text-secondary transition-colors hover:text-text-primary">
      ...
      {/* Filter - Availability */}
      <fieldset className="space-y-4">
        <legend className="text-mono-caption w-full border-b border-line pb-2 text-text-muted">Availability</legend>
        <div className="flex flex-col space-y-3 pt-2">
          <label className="group flex h-11 cursor-pointer items-center gap-3 text-body text-text-secondary transition-colors hover:text-text-primary">
            <input 
              type="checkbox" 
              ...
              className="size-[18px] shrink-0 rounded-none accent-bone" 
            />
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      <Dialog.Trigger asChild>
        <button className="inline-flex h-11 items-center gap-2 border border-line px-5 text-body-small text-text-secondary transition-colors hover:border-bone hover:text-text-primary">
          ...
          <Dialog.Portal forceMount>
            ...
            >
              <motion.div
                ...
                className="fixed inset-x-0 bottom-0 z-50 flex max-h-[85dvh] flex-col border-t border-line bg-ink outline-none"
              >
                <div className="flex h-16 shrink-0 items-center justify-between border-b border-line px-gutter">
                  <Dialog.Title className="text-h3 text-text-primary">Filter &amp; sort</Dialog.Title>
                  <Dialog.Close asChild>
                    <button className="-mr-2.5 flex size-11 items-center justify-center text-text-primary transition-opacity hover:opacity-70">
                ...
                <div className="shrink-0 border-t border-line px-gutter py-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
                  <button 
                    ...
                    className="h-[52px] w-full bg-bone text-body font-medium text-ink transition-colors hover:bg-paper active:opacity-[0.86]"
                  >
                    Done
                  </button>
                </div>
